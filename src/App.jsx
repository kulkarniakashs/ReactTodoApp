...
function App() {
  ...
  return (
    <div>
      <Navbar />
      <div className="container w-4/5 h-4/6 rounded-xl mx-auto my-5 pt-7 bg-violet-400 min-h-[80vh]">
        ...
        <div className="body bg-violet-400 mt-5">
          ...
          {todos.map(items=>{
            return (showFinished || !items.isCompleted) && ((<div className="todo flex justify-around gap-6 my-2 font-medium" key={items.id}>
              <div className='flex  flex-start gap-2 min-w-[36%]'>
